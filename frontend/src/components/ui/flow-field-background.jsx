...
export default function NeuralBackground({
    ...
    useEffect(() => {
        ...
        // Use current theme colors if not explicitly provided
        const particleColor = color || (theme === 'dark' ? '#f97316' : '#ea580c'); // primary-500 or 600
        const bgColor = theme === 'dark' ? `rgba(2, 6, 23, ${trailOpacity})` : `rgba(248, 250, 252, ${trailOpacity})`; // slate-950 or slate-50
        ...
        // Use ResizeObserver for more robust resizing over window resize event
    ...
    }, [theme, color, trailOpacity, particleCount, speed]); // React to theme changes
